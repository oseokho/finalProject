	                               	...
	                               	<div class="col-sm-12">
	                               		<form method="post">
		                               		<table class="table table-bordered dataTable text-center" id="dataTable">
		                                        <tr>
				                                    <th>ID</th>
				                                    <td><c:out value="${withdraw.id}"/>
				                                    <input type="hidden" id="id" name="id" value="${withdraw.id}"></td>
				                                    <th>탈퇴날짜</th>
				                            		<td><c:out value="${withdraw.wdate}"/></td>
				                                    <th>탈퇴사유</th>
				                            		<td><input value="${withdraw.comments}" id="comments" name="comments"></td>
		                                        </tr>
		                               		</table>
				                        	...
				                        	<input type="hidden" name="keyword" value="${cri.keyword}">
		                               		<div class="float-right">
	                        					<sec:csrfInput/>
			                               		...
			                               		<button class="btn btn-danger" formaction="remove" id="btnRm">Remove</button>
